...
async function main() {
  ...
  try {
    ...
    const voiceBridge = spawn(process.execPath, [path.join(ROOT, 'services', 'ib-bridge-service.js')], {
      cwd: ROOT,
    ...
    const cloneBridge = spawn(process.execPath, [path.join(ROOT, 'services', 'ib-bridge-service.js')], {
      cwd: ROOT,
    ...
    const designBridge = spawn(process.execPath, [path.join(ROOT, 'services', 'ib-bridge-service.js')], {
      cwd: ROOT,
