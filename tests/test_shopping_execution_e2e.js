...
const createCommerce = require(path.join(ROOT, 'active', 'commerce.js')).create;
const createPaymentAuth = require(path.join(ROOT, 'active', 'payment-auth.js')).createPaymentAuth;
const createPayGate = require(path.join(ROOT, 'bridge', 'pay-gate.js'));
const createProviderRegistry = require(path.join(ROOT, 'bridge', 'payment-provider.js')).createPaymentProviderRegistry;
const createAlipayProvider = require(path.join(ROOT, 'bridge', 'alipay-provider.js'));
const IBShopExec = require(path.join(ROOT, 'active', 'shopping-execution.js'));
