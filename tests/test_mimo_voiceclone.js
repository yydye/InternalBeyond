...
const createTts = require(path.join(ROOT, 'bridge', 'tts'));
const createTtsVoices = require(path.join(ROOT, 'bridge', 'tts-voices'));
...
async function main() {
  ...
  {
    const src = fs.readFileSync(path.join(ROOT, 'bridge', 'tts.js'), 'utf8');
