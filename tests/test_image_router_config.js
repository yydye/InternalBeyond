...
const MODELS = require(path.join(ROOT, 'assets', 'js', 'image-models-core.js'));
const CORE = require(path.join(ROOT, 'assets', 'js', 'image-router-core.js'));
...
require(path.join(ROOT, 'assets', 'js', 'image-router-config.js'));
