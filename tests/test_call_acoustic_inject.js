...
require(path.join(ROOT, 'assets', 'js', 'communication', 'voice.js')); /* 提供 _vmPcmToAudioLike/_vmToneAnalyze/_vmAudioNative */
require(path.join(ROOT, 'assets', 'js', 'communication', 'call.js'));  /* 提供 _acousticReferenceFor */
